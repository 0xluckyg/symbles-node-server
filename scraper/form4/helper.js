...
function formatPurchaseData(transaction) {
    ...
    let transactionAmounts = transaction.transactionAmounts.transactionShares || transaction.transactionAmounts.transactionTotalValue    
    let numberOfShares = transactionAmounts.value;    
